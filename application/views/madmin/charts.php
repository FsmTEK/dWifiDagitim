...
<html lang="tr">
  <head>
    ...
    <!-- Bootstrap core CSS-->
    <link href="<?=base_url('elz/vendor/bootstrap/css/bootstrap.min.css');?>" rel="stylesheet">
    <!-- Custom fonts for this template-->
    <link href="<?=base_url('elz/vendor/fontawesome-free/css/all.min.css');?>" rel="stylesheet" type="text/css">
    <!-- Page level plugin CSS-->
    <link href="<?=base_url('elz/vendor/datatables/dataTables.bootstrap4.css');?>" rel="stylesheet">
    <!-- Custom styles for this template-->
    <link href="<?=base_url('elz/css/sb-admin.css')?>" rel="stylesheet">
  </head>
  <body id="page-top">
      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Çizelgeler</li>
          </ol>
          ...
          <p class="small text-center text-muted my-5">
            <em>Daha fazla grafik örneği yakında ...</em>
          </p>
    ...
    <script src="<?=base_url('elz/vendor/chart.js/Chart.min.js');?>"></script>
    <!-- Custom scripts for all pages-->
    <script src="<?=base_url('elz/js/sb-admin.min.js');?>"></script>
    <!-- Demo scripts for this page-->
    <script src="<?=base_url('elz/js/demo/chart-area-demo.js');?>"></script>
    <script src="<?=base_url('elz/js/demo/chart-bar-demo.js');?>"></script>
    <script src="<?=base_url('elz/js/demo/chart-pie-demo.js');?>"></script>
